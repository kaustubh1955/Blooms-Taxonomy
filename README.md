This is an android application which takes a pdf file of a question paper as input, scans out all the question from it, and classifies each question into different cognitive level
